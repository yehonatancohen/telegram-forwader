        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "הוראות הפלט:\n"
                    "1. פתח/י בכותרת קצרה ובולטת בתחילת השורה - מוקפת בשני כוכביות **כך** כדי שתודגש בטלגרם.\n"
                    "2. אחר-כך כתוב/י 5-6 משפטים בעברית קולחת שמסכמים את הידיעה.\n"
                    "   • השתמש/י בפעלים חזקים (לדוגמה: “הקפיץ”, “הדהים”, “הסעיר”).\n"
                    "   • הדגש/י מספרים ועובדות חשובות.\n"
                    "   • אפשר לשלב אימוג’י רלוונטי בודד או שניים (לא חובה) כדי להגביר עניין.\n"
                    "3. אל תכתוב/י דעה אישית, אבל שמור/י על טון מסקרן, קליל ומזמין.\n"
                    "4. אל תחרוג/י מ-650 תווים בסך-הכול."
                )
            },
            {
                "role": "user",
